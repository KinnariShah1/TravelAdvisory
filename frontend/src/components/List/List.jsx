    ...
    return (
        <div className={classes.container}>
            ...
            {isLoading ? (
                ...
                <>
            <FormControl clasName={classes.formControl}>
                <InputLabel>Type</InputLabel>
                <Select value={type} onChange={(e) => setType(e.target.value)} className="type">
            ...
            <FormControl clasName={classes.formControl}>
                ...
                <Select value={rating} onChange={(e) => setRating(e.target.value)} className="rate">
